...
.history-list ion-item, .favorites-list ion-item {
...
.plant-description {
  ...
  font-size: 1rem;
  color: #333;
  padding-top: 10px; /* Ajout d'un espace pour libérer le texte sous la barre de navigation */
}
ion-content {
  padding-top: 50em; /* Espace ajouté avant la barre de navigation pour le contenu */
}
</style>
